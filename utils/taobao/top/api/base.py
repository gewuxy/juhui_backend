...
SYSTEM_GENERATE_VERSION = "taobao-sdk-python-20170616"
...
class RestApi(object):
    ...
    def getResponse(self, authrize=None, timeout=30):
        ...
        connection = httplib.HTTPConnection(self.__domain, port=self.__port, timeout=timeout)
        sys_parameters = {
            P_FORMAT: 'json',
            P_APPKEY: self.__app_key,
            P_SIGN_METHOD: "md5",
            P_VERSION: '2.0',
            P_TIMESTAMP: str(int(float(time.time()) * 1000)),
